...
const page = getTopicBySlug("seo-strategy")!;

export const metadata: Metadata = buildGuideMetadata(page);

export default function SeoStrategyPage() {
  const articles = getArticlesByTopic("seo-strategy");

  return (
    <GuideLayout pathname="/seo-guide/seo-strategy">
      {/* Hero */}
      <section className="relative overflow-hidden pt-6 pb-6 md:pt-8 md:pb-8">
        ...
        <div className="relative mx-auto max-w-[720px] px-6">
          ...
          <p className="animate-hero-delay-2 mt-5 text-[16px] leading-[1.7] text-muted">
            SEO without a strategy is just guessing. This guide covers how to
            plan your SEO with realistic timelines, clear priorities, and a
            framework that turns effort into measurable growth.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[720px] px-6">
          ...
          <div className="reveal reveal-delay-1 mt-6">
            <p className="text-[15px] leading-[1.75] text-muted">
              Knowing SEO tactics is not enough. You need a plan that tells you
              what to do first, how long to expect results, and where to focus
              your limited time and resources. This topic covers realistic
              timelines, startup-specific strategies, and how to prioritize for
              maximum impact.
            </p>
            <p className="mt-4 text-[15px] leading-[1.75] text-muted">
              For the full SEO picture, see our{" "}
              <a
                href="/seo-guide"
        ...
        <div className="mx-auto max-w-[720px] px-6">
          <div className="reveal rounded-2xl border border-accent/20 bg-accent-bg/30 p-6 text-center">
            ...
            <p className="mt-2 text-[14px] text-muted">
              RankSEO helps you prioritize keywords, plan content, and track
              progress with real data.
            </p>
      ...
      <GuideRelated pathname="/seo-guide/seo-strategy" />
    </GuideLayout>
  );
}
