        ...
        <div className="reveal reveal-delay-1 mx-auto grid max-w-[720px] gap-4 sm:grid-cols-3">
          {links.map((link) => (
            ...
            >
              ...
              <svg className="ml-auto h-4 w-4 text-muted-light transition-all group-hover:translate-x-0.5 group-hover:text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
